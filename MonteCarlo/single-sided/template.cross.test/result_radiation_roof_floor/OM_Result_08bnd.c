...
void OM_Result_eqFunction_402(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[104] /* two_single_ventilation1._Indoor_temperature._port._Q_flow variable */ = 0.0;
  TRACE_POP
}
...
void OM_Result_eqFunction_404(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[99] /* Temperature_sky._port._Q_flow variable */ = 0.0;
  TRACE_POP
}
...
void OM_Result_eqFunction_413(DATA *data, threadData_t *threadData)
{
  ...
  if(!tmp53)
  {
    tmp50 = GreaterEq(data->simulationInfo->realParameter[74],0.0);
    if(!tmp50)
    {
      tmp52 = modelica_real_to_modelica_string_format(data->simulationInfo->realParameter[74], (modelica_string) mmc_strings_len1[103]);
