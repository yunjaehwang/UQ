...
void OM_Result_eqFunction_184(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp0, data->localData[0]->timeValue, data->simulationInfo->realVarsPre[120] /* Data_solar_radiation._nextTimeEvent DISCRETE */, 2, GreaterEq);
...
void OM_Result_eqFunction_185(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp1, data->localData[0]->timeValue, data->simulationInfo->realVarsPre[118] /* Data_outdoor_temperature._nextTimeEvent DISCRETE */, 1, GreaterEq);
...
void OM_Result_eqFunction_186(DATA *data, threadData_t *threadData)
{
  ...
  RELATIONHYSTERESIS(tmp2, data->localData[0]->timeValue, data->simulationInfo->realVarsPre[122] /* Data_wind_speed._nextTimeEvent DISCRETE */, 0, GreaterEq);
...
void OM_Result_eqFunction_189(DATA *data, threadData_t *threadData)
{
  ...
  if((data->localData[0]->booleanVars[0] /* $whenCondition1 DISCRETE */ && !data->simulationInfo->booleanVarsPre[0] /* $whenCondition1 DISCRETE */ /* edge */))
  {
    tmp3 = Less(data->localData[0]->realVars[123] /* Data_wind_speed._nextTimeEventScaled DISCRETE */,9.999999999999999e+59);
    data->localData[0]->realVars[122] /* Data_wind_speed._nextTimeEvent DISCRETE */ = (tmp3?(data->localData[0]->realVars[123] /* Data_wind_speed._nextTimeEventScaled DISCRETE */) * (60.0):9.999999999999999e+59);
  }
  TRACE_POP
}
/*
...
void OM_Result_eqFunction_190(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[12] /* $cse3 variable */ = omc_Modelica_Blocks_Tables_Internal_getTimeTableValue(threadData, data->simulationInfo->extObjs[2], ((modelica_integer) 1), data->localData[0]->realVars[69] /* Data_wind_speed._timeScaled variable */, data->localData[0]->realVars[123] /* Data_wind_speed._nextTimeEventScaled DISCRETE */, data->simulationInfo->realVarsPre[123] /* Data_wind_speed._nextTimeEventScaled DISCRETE */);
  TRACE_POP
}
/*
 equation index: 191
...
void OM_Result_eqFunction_192(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[105] /* two_single_ventilation1._U_square._y variable */ = (tmp4 * tmp4);
  TRACE_POP
}
/*
 equation index: 193
...
void OM_Result_eqFunction_198(DATA *data, threadData_t *threadData)
{
  ...
  if((data->localData[0]->booleanVars[1] /* $whenCondition2 DISCRETE */ && !data->simulationInfo->booleanVarsPre[1] /* $whenCondition2 DISCRETE */ /* edge */))
  {
    tmp7 = Less(data->localData[0]->realVars[119] /* Data_outdoor_temperature._nextTimeEventScaled DISCRETE */,9.999999999999999e+59);
    data->localData[0]->realVars[118] /* Data_outdoor_temperature._nextTimeEvent DISCRETE */ = (tmp7?(data->localData[0]->realVars[119] /* Data_outdoor_temperature._nextTimeEventScaled DISCRETE */) * (60.0):9.999999999999999e+59);
  }
  TRACE_POP
}
/*
...
void OM_Result_eqFunction_199(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[11] /* $cse2 variable */ = omc_Modelica_Blocks_Tables_Internal_getTimeTableValue(threadData, data->simulationInfo->extObjs[0], ((modelica_integer) 1), data->localData[0]->realVars[65] /* Data_outdoor_temperature._timeScaled variable */, data->localData[0]->realVars[119] /* Data_outdoor_temperature._nextTimeEventScaled DISCRETE */, data->simulationInfo->realVarsPre[119] /* Data_outdoor_temperature._nextTimeEventScaled DISCRETE */);
  TRACE_POP
}
/*
 equation index: 200
...
void OM_Result_eqFunction_201(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[100] /* multiProduct1._u[2] variable */ = sqrt(tmp8);
  TRACE_POP
}
/*
 equation index: 202
...
void OM_Result_eqFunction_205(DATA *data, threadData_t *threadData)
{
  ...
  tmp9 = GreaterEq(data->localData[0]->realVars[112] /* two_single_ventilation1._multiProduct5._u[3] variable */,0.0);
  data->localData[0]->realVars[108] /* two_single_ventilation1._multiProduct1._u[3] variable */ = (tmp9?data->localData[0]->realVars[112] /* two_single_ventilation1._multiProduct5._u[3] variable */:(-data->localData[0]->realVars[112] /* two_single_ventilation1._multiProduct5._u[3] variable */));
  TRACE_POP
}
/*
 equation index: 206
...
void OM_Result_eqFunction_208(DATA *data, threadData_t *threadData)
{
  ...
  modelica_real tmp10;
  tmp10 = data->localData[0]->realVars[115] /* two_single_ventilation1._multiSum1._y variable */;
  if(!(tmp10 >= 0.0))
  {
    FILE_INFO info = {"",0,0,0,0,0};
    omc_assert_warning(info, "The following assertion has been violated %sat time %f", initial() ? "during initialization " : "", data->localData[0]->timeValue);
  ...
  data->localData[0]->realVars[109] /* two_single_ventilation1._multiProduct3._u[3] variable */ = sqrt(tmp10);
  TRACE_POP
}
/*
 equation index: 209
...
void OM_Result_eqFunction_212(DATA *data, threadData_t *threadData)
{
  ...
  modelica_real tmp11;
  tmp11 = data->localData[0]->realVars[117] /* two_single_ventilation1._multiSum2._y variable */;
  if(!(tmp11 >= 0.0))
  {
    FILE_INFO info = {"",0,0,0,0,0};
    omc_assert_warning(info, "The following assertion has been violated %sat time %f", initial() ? "during initialization " : "", data->localData[0]->timeValue);
  ...
  data->localData[0]->realVars[110] /* two_single_ventilation1._multiProduct4._u[3] variable */ = sqrt(tmp11);
  TRACE_POP
}
/*
 equation index: 213
...
void OM_Result_eqFunction_219(DATA *data, threadData_t *threadData)
{
  ...
  if((data->localData[0]->booleanVars[2] /* $whenCondition3 DISCRETE */ && !data->simulationInfo->booleanVarsPre[2] /* $whenCondition3 DISCRETE */ /* edge */))
  {
    tmp12 = Less(data->localData[0]->realVars[121] /* Data_solar_radiation._nextTimeEventScaled DISCRETE */,9.999999999999999e+59);
    data->localData[0]->realVars[120] /* Data_solar_radiation._nextTimeEvent DISCRETE */ = (tmp12?(data->localData[0]->realVars[121] /* Data_solar_radiation._nextTimeEventScaled DISCRETE */) * (60.0):9.999999999999999e+59);
  }
  TRACE_POP
}
/*
...
void OM_Result_eqFunction_220(DATA *data, threadData_t *threadData)
{
  ...
  data->localData[0]->realVars[10] /* $cse1 variable */ = omc_Modelica_Blocks_Tables_Internal_getTimeTableValue(threadData, data->simulationInfo->extObjs[1], ((modelica_integer) 1), data->localData[0]->realVars[67] /* Data_solar_radiation._timeScaled variable */, data->localData[0]->realVars[121] /* Data_solar_radiation._nextTimeEventScaled DISCRETE */, data->simulationInfo->realVarsPre[121] /* Data_solar_radiation._nextTimeEventScaled DISCRETE */);
  TRACE_POP
}
/*
 equation index: 221
...
void OM_Result_eqFunction_232(DATA*,threadData_t*);
/*
 equation index: 238
 indexNonlinear: 8
 type: NONLINEAR
...
void OM_Result_eqFunction_251(DATA *data, threadData_t *threadData)
{
  ...
  if(ACTIVE_STREAM(LOG_DT))
  {
    infoStreamPrint(LOG_DT, 1, "Solving nonlinear system 251 (STRICT TEARING SET if tearing enabled) at time = %18.10e", data->localData[0]->timeValue);
    messageClose(LOG_DT);
  }
  /* get old value */
  ...
  if (retValue > 0){
    ...
    throwStreamPrintWithEquationIndexes(threadData, indexes, "Solving non-linear system 251 failed at time=%.15g.\nFor more information please use -lv LOG_NLS.", data->localData[0]->timeValue);
  }
  /* write solution */
...
void OM_Result_eqFunction_291(DATA*,threadData_t*);
/*
 equation index: 298
 indexNonlinear: 12
 type: NONLINEAR
 ...
 eqns: {285, 286, 287, 288, 289, 290, 291}
 */
void OM_Result_eqFunction_298(DATA *data, threadData_t *threadData)
{
  ...
  if(ACTIVE_STREAM(LOG_DT))
  {
    infoStreamPrint(LOG_DT, 1, "Solving nonlinear system 298 (STRICT TEARING SET if tearing enabled) at time = %18.10e", data->localData[0]->timeValue);
    messageClose(LOG_DT);
  }
  /* get old value */
  ...
  if (retValue > 0){
    ...
    throwStreamPrintWithEquationIndexes(threadData, indexes, "Solving non-linear system 298 failed at time=%.15g.\nFor more information please use -lv LOG_NLS.", data->localData[0]->timeValue);
  }
  /* write solution */
...
/*
 ...
 eqns: {302, 303, 304, 305, 306, 307, 308}
 */
...
void OM_Result_eqFunction_331(DATA *data, threadData_t *threadData)
{
  ...
  if(ACTIVE_STREAM(LOG_DT))
  {
    infoStreamPrint(LOG_DT, 1, "Solving nonlinear system 331 (STRICT TEARING SET if tearing enabled) at time = %18.10e", data->localData[0]->timeValue);
    messageClose(LOG_DT);
  }
  /* get old value */
  ...
  /* check if solution process was successful */
  if (retValue > 0){
    const int indexes[2] = {1,331};
    throwStreamPrintWithEquationIndexes(threadData, indexes, "Solving non-linear system 331 failed at time=%.15g.\nFor more information please use -lv LOG_NLS.", data->localData[0]->timeValue);
  }
  /* write solution */
...
void OM_Result_eqFunction_345(DATA *data, threadData_t *threadData)
{
  ...
  if(ACTIVE_STREAM(LOG_DT))
  {
    infoStreamPrint(LOG_DT, 1, "Solving nonlinear system 345 (STRICT TEARING SET if tearing enabled) at time = %18.10e", data->localData[0]->timeValue);
    messageClose(LOG_DT);
  }
  /* get old value */
  ...
  if (retValue > 0){
    ...
    throwStreamPrintWithEquationIndexes(threadData, indexes, "Solving non-linear system 345 failed at time=%.15g.\nFor more information please use -lv LOG_NLS.", data->localData[0]->timeValue);
  }
  /* write solution */
...
void OM_Result_setupDataStruc(DATA *data, threadData_t *threadData)
{
  ...
  data->modelData->nVariablesReal = 124;
  ...
  data->modelData->modelDataXml.nEquations = 455;
