...
#define Modelica_Utilities_Strings_isEmpty_index 6
#define Modelica_Utilities_Strings_length_index 7
#define Modelica_Utilities_Strings_Advanced_skipWhiteSpace_index 8
