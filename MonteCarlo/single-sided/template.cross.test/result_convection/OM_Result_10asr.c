...
void OM_Result_eqFunction_466(DATA *data, threadData_t *threadData)
{
  ...
  if(!tmp59)
  {
    tmp56 = GreaterEq(data->localData[0]->realVars[102] /* Temperature_sky._T variable */,0.0);
    if(!tmp56)
    {
      tmp58 = modelica_real_to_modelica_string_format(data->localData[0]->realVars[102] /* Temperature_sky._T variable */, (modelica_string) mmc_strings_len1[103]);
