...
// parameters
  constant String inputDataLoc = "/home/yunjaeh/github/UQ/MonteCarlo/weatherInputs/Night_0211.mat";
  
// Uncertain parameters
  constant Real convection_coef_outer = 1.2232;
  constant Real convection_coef_inner = 1.2688;
  constant Real infiltration = 3.3678;
  constant Real reflectance_roof = 0.31741;
  constant Real qt_temperature = 0.47349;
  constant Real qt_wind = 0.3386;
  constant Real qt_radiation = 0.41438;
  constant Real emissivity_roof = 0.14009;
...
// model blocks
  ...
  Modelica.Blocks.Sources.Constant Convection_A(k = 4.4 * convection_coef_outer) annotation(
    Placement(visible = true, transformation(origin = {-220, -180}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Sources.Constant Convection_B(k = 0.78) annotation(
...
// wind speed blocks
  connect(WindSpeed, two_single_ventilation1.Port_wind) annotation(
...
// other blocks
  ...
  annotation(
    ...
    experiment(StartTime = 0, StopTime = 129600, Tolerance = 1e-6, Interval = 120.00),
