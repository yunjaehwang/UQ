...
// fixed parameters
  constant Real area_opening_1 = 0.6598;
  constant Real area_opening_2 = 0.62;
  constant Real height_1 = 0.25;
  constant Real height_2 = 0.91;

// uncertain parameters
  constant Real ventilation_rate_1 = 1.2578;
  constant Real ventilation_rate_2 = 1.2211;
...
equation
  ...
  connect(Port_wind, U_square.u2) annotation(
    Line(points = {{-140, 70}, {-114, 70}, {-114, 64}, {-102, 64}}, color = {0, 0, 127}));
  connect(Port_wind, U_square.u1) annotation(
