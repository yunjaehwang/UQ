...
void OM_Result_eqFunction_386(DATA *data, threadData_t *threadData)
{
  ...
  data->simulationInfo->extObjs[1] = omc_Modelica_Blocks_Types_ExternalCombiTimeTable_constructor(threadData, data->simulationInfo->stringParameter[3], (((!stringEqual(data->simulationInfo->stringParameter[2], _OMC_LIT20)) && (!omc_Modelica_Utilities_Strings_isEmpty(threadData, data->simulationInfo->stringParameter[2])))?data->simulationInfo->stringParameter[2]:_OMC_LIT20), _OMC_LIT21, (data->simulationInfo->realParameter[38]) / tmp1, tmp2, 1, (modelica_integer)data->simulationInfo->integerParameter[8], (data->simulationInfo->realParameter[37]) / tmp3, (modelica_integer)data->simulationInfo->integerParameter[11], data->simulationInfo->booleanParameter[5]);
  TRACE_POP
}
...
void OM_Result_eqFunction_390(DATA *data, threadData_t *threadData)
{
  ...
  data->simulationInfo->extObjs[2] = omc_Modelica_Blocks_Types_ExternalCombiTimeTable_constructor(threadData, data->simulationInfo->stringParameter[5], (((!stringEqual(data->simulationInfo->stringParameter[4], _OMC_LIT20)) && (!omc_Modelica_Utilities_Strings_isEmpty(threadData, data->simulationInfo->stringParameter[4])))?data->simulationInfo->stringParameter[4]:_OMC_LIT20), _OMC_LIT21, (data->simulationInfo->realParameter[48]) / tmp9, tmp10, 1, (modelica_integer)data->simulationInfo->integerParameter[14], (data->simulationInfo->realParameter[47]) / tmp11, (modelica_integer)data->simulationInfo->integerParameter[17], data->simulationInfo->booleanParameter[8]);
  TRACE_POP
}
...
void OM_Result_eqFunction_445(DATA *data, threadData_t *threadData)
{
  ...
  if(!tmp53)
  {
    tmp50 = GreaterEq(data->simulationInfo->realParameter[80],0.0);
    if(!tmp50)
    {
      tmp52 = modelica_real_to_modelica_string_format(data->simulationInfo->realParameter[80], (modelica_string) mmc_strings_len1[103]);
...
void OM_Result_eqFunction_469(DATA *data, threadData_t *threadData)
{
  ...
  if(!tmp152)
  {
    tmp149 = GreaterEq(data->simulationInfo->realParameter[55],0.0);
    if(!tmp149)
    {
      tmp151 = modelica_real_to_modelica_string_format(data->simulationInfo->realParameter[55], (modelica_string) mmc_strings_len1[103]);
...
void OM_Result_eqFunction_470(DATA *data, threadData_t *threadData)
{
  ...
  if(!tmp156)
  {
    tmp153 = GreaterEq(data->simulationInfo->realParameter[57],0.0);
    if(!tmp153)
    {
      tmp155 = modelica_real_to_modelica_string_format(data->simulationInfo->realParameter[57], (modelica_string) mmc_strings_len1[103]);
